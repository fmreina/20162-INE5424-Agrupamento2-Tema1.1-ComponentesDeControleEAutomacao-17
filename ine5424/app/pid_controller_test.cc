...
void runPTest() {
	...
	Controller* pctrl = new P_controller(sensor, actuating, max, min, setpoint, dt, &P_controller::P, kp);
...
void runITest() {
	...
	Controller* ictrl = new I_controller(sensor, actuating, max, min, setpoint, dt, &I_controller::I, ki);
...
void runDTest() {
	...
	Controller* dctrl = new D_controller(sensor, actuating, max, min, setpoint, dt, &D_controller::D, kd);
...
void runPITest() {
	...
	Controller* pictrl = new PI_controller(sensor, actuating, max, min, setpoint, dt, &PI_controller::PI, kp, ki);
...
void runPDTest() {
	...
	Controller* pdctrl = new PD_controller(sensor, actuating, max, min, setpoint, dt, &PD_controller::PD, kp, kd);
...
void runPIDTest() {
	...
	Controller* pctrl = new PID_controller(sensor, actuating, max, min, setpoint, dt, &PID_controller::PID, kp, ki, kd);
