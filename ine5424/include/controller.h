...
class Controller
{
  ...
  public:
    ...
    Controller(void (* control)(Args... args), Args... args)
    {
      Run(control, args...);
    }
    // Controller(float sensor, Actuating_Interface* actuating, float dt, void (* control)(Args... args), Args... args):
    // 	_sensor(sensor),
  ...
  public:
    ...
    // @params _kp
    void static P(float sensor, float actuating, float _kp) {
